...
if "memory" not in st.session_state:
    st.session_state.memory = ConversationBufferMemory(memory_key="chat_history", return_messages=False)
...
if st.button("Ask AI") and user_input.strip():
        with st.spinner("Thinking..."):
            response_text=system_prompts(user_input)
